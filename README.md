...
The project is organized into 5 classes within a single main file:
...
data/
├── table-creator.py  → Attack table generation script
...
```python
from chess_game import Board, MoveGen, ChessDisplay
...
```python
from chess_game import Board, GameState, MoveGen
from constants import *
...
```python
from chess_game import Board, MoveGen, GameState
from constants import *
